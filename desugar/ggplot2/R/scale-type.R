...
#' @export
scale_type.logical <- function(x) {
    force(x)
 "discrete"
}

#' @export
scale_type.character <- function(x) {
    force(x)
 "discrete"
}

#' @export
scale_type.ordered <- function(x) {
    force(x)
 c("ordinal", "discrete")
}
...
#' @export
scale_type.POSIXt <- function(x) {
    force(x)
 c("datetime", "continuous")
}

#' @export
scale_type.Date <- function(x) {
    force(x)
 c("date", "continuous")
}

#' @export
scale_type.numeric <- function(x) {
    force(x)
 "continuous"
}
